...
// Called when the command is initially scheduled.
  ...
  public void execute() {
    ...
    if (m_enabled) {
      upperMotorRps = SmartDashboard.getNumber("desired motor1 RPS", Constants.LauncherConstants.UpperMotorSpeedRps);
      lowerMotorRps = SmartDashboard.getNumber("desired motor2 RPS", Constants.LauncherConstants.LowerMotorSpeedRps);
    } else {
     upperMotorRps  = 0.0;
     lowerMotorRps = 0.0;
    }
